function mypackage_make_release(newVersion)
% Cut a release of myproject
%
% mypackage_make_release newVersion
%
...
if ismac
  ...
  system('open "https://github.com/myghuser/myproject/releases"')
end
